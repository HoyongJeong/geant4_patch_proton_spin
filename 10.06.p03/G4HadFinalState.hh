...
public:
  ...
  // 29-Sep-16 by H. Jeong
  ////////////////////////////////////////////////////////////////////////////////
  inline
  void SetPolarizationChange(const G4ThreeVector& aP){ thePolarization=aP; }
  void SetPolarizationChange(G4double x, G4double y, G4double z);
  inline
  const G4ThreeVector& GetPolarizationChange() const { return thePolarization; }
  inline
  void SetQuasiElastic(const G4bool& aB){ theQuasiElastic=aB; }
  inline
  const G4bool& GetQuasiElastic() const { return theQuasiElastic; }
  ////////////////////////////////////////////////////////////////////////////////
