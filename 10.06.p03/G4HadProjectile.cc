...
void G4HadProjectile::InitialiseLocal(const G4DynamicParticle* dp)
{
  ...
  // 17-May-16 by H. Jeong
  ////////////////////////////////////////////////////////////////////////////////
  // Describing polarization rotation
  // Choice 1. In this case, polarization is fixed globally.
  G4RotationMatrix toZForPol;
  toZForPol.rotateZ(-theOrgMom.phi());
  toZForPol.rotateY(-theOrgMom.theta());
  thePol = toZForPol*theOrgPol;
  toLabFrameForPol = toZForPol.inverse();

  // Choice 2. In this case, polarization is always proportioal to momentum.
  // ( Not described yet. )
  ////////////////////////////////////////////////////////////////////////////////
