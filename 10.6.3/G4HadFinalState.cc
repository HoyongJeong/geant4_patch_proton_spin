...
////////////////////////////////////////////////////////////////////////////////
void G4HadFinalState::SetPolarizationChange(G4double x, G4double y, G4double z)
{
  thePolarization.set(x,y,z);
  if(std::fabs(x*x + y*y + z*z - 1.0)>0.001) {
    G4cout <<"We have negative thePolarizattion.mag() = "<<thePolarization.mag()
    <<G4endl;
    throw G4HadronicException(__FILE__, __LINE__,
    "G4HadFinalState: fatal - negative polarization direction.mag().");
  }
}
////////////////////////////////////////////////////////////////////////////////
